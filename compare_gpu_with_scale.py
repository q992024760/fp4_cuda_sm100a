...
def main():
    ...
    # 读取日志文件
    with open('test_e8m0_2X_128_32_256.log', 'r', encoding='utf-8') as f:
        log_content = f.read()

    # --- 解析矩阵 ---
    mat_a = parse_matrix_from_log(log_content, 'Mat_A', 128, 256)
    mat_b = parse_matrix_from_log(log_content, 'Mat_B', 32, 256)
    mat_c_from_log = parse_matrix_from_log(log_content, 'Mat_C', 128, 32)
